...
I am no longer running SecuritySpy so I have no access to the Software anymore. I am looking for someone to take over the code, as I will not make any changes to it. If no one is found, I will archive this repository and remove it from the Default HACS store. Sorry for any inconvenience this may cause.
